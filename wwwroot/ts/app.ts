...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["React"] = __webpack_require__(93);
...
var k=__webpack_require__(63),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.concurrent_mode"):60111,y=n?Symbol.for("react.forward_ref"):60112,z=n?Symbol.for("react.suspense"):60113,aa=n?Symbol.for("react.memo"):
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(131);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(40), __webpack_require__(324)(module)))
...
$export($export.S + $export.F * !__webpack_require__(10), 'Object', { defineProperties: __webpack_require__(100) });
...
$export($export.P + $export.F * (__webpack_require__(47) != Object || !__webpack_require__(18)(arrayJoin)), 'Array', {
...
var $export = __webpack_require__(1);
var flattenIntoArray = __webpack_require__(283);
var toObject = __webpack_require__(11);
var toLength = __webpack_require__(7);
var aFunction = __webpack_require__(20);
...
var hide = __webpack_require__(312);
...
var createDesc = __webpack_require__(318);
...
module.exports = !__webpack_require__(92) && !__webpack_require__(129)(function () {
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Components"] = __webpack_require__(330);
...
function createProvider(storeKey) {
  ...
  function (_Component) {
    ...
    _proto.render = function render() {
      return index_js_exposed["Children"].only(this.props.children);
    };

    return Provider;
  }(index_js_exposed["Component"]);
...
var hoist_non_react_statics_cjs = __webpack_require__(130);
var hoist_non_react_statics_cjs_default = /*#__PURE__*/__webpack_require__.n(hoist_non_react_statics_cjs);

// EXTERNAL MODULE: ./node_modules/invariant/browser.js
var browser = __webpack_require__(64);
var browser_default = /*#__PURE__*/__webpack_require__.n(browser);

// EXTERNAL MODULE: ./node_modules/react-is/index.js
var react_is = __webpack_require__(95);
    ...
    function (_Component) {
      ...
      _proto.render = function render() {
        ...
        if (selector.error) {
          ...
          return Object(index_js_exposed["createElement"])(WrappedComponent, this.addExtraProps(selector.props));
        }
      };
...
// CONCATENATED MODULE: ./Client/components/Filter.tsx
...
var Filter_Filter = /** @class */ (function (_super) {
    ...
    Filter.prototype.render = function () {
        var _this = this;
        return (index_js_exposed["createElement"]("form", { className: "form-group-sm" },
            index_js_exposed["createElement"]("label", { className: "control-label", htmlFor: this.props.id }, this.props.name),
            index_js_exposed["createElement"]("select", { disabled: this.props.loading, className: "form-control input-sm full-width", value: this.props.selected, name: "index", id: this.props.id, onChange: function (e) { return _this.props.onSelect(Number.parseInt(e.currentTarget.value)); } }, this.props.items.map(function (item) { return index_js_exposed["createElement"]("option", { key: item.value, value: item.value }, item.text); })),
            index_js_exposed["createElement"]("div", { ref: function (noscript) { return _this.noscript = noscript; }, className: "full-width text-center" },
                index_js_exposed["createElement"]("input", { className: "btn btn-xs btn-default full-width", type: "submit" }))));
    };
    return Filter;
}(index_js_exposed["Component"]));


// CONCATENATED MODULE: ./Client/components/FilterBox.tsx
...
function FilterBox(props) {
    ...
    return (index_js_exposed["createElement"]("div", { className: "col-md-3 padding-15 " },
        index_js_exposed["createElement"]("span", { className: "text-info" },
            props.prompt,
            ":"),
        index_js_exposed["createElement"]("div", { className: "form-group-md" }, props.filters.map(function (filter, i) {
            return index_js_exposed["createElement"](Filter_Filter, { key: i, id: "drop" + i, name: filter.name, items: filter.items, selected: filter.selected, onSelect: function (selected) { return selectFilter(selected); }, loading: props.loading });
        }))));
}

// CONCATENATED MODULE: ./Client/reducers/dataExplorerReducer.ts
...
var initState = function (payload) {
    return { type: "INIT_STATE", payload: payload };
};
var updateLoadState = function (payload) {
    return { type: "LOAD", payload: payload };
};
var updateFilters = function (payload) {
    return { type: "UPDATE_FILTERS", payload: payload };
};
var updateChartData = function (payload) {
    return { type: "UPDATE_DATA", payload: payload };
};
var dataExplorerReducer = function (previousState, action) {
...
// CONCATENATED MODULE: ./Client/store/dataExplorer.ts


var dataExplorerStore = createStore(dataExplorerReducer);

// CONCATENATED MODULE: ./Client/containers/Filters.tsx
// @flow
...
var mapStateToFilterProps = function (state, props) {
    return ({ loading: state.loading, filters: state.filters, prompt: props.prompt });
};
var Filters_mapDispatchToProps = function (dispatch) {
    return {
...
var FilterBoxConnect = connect_connect(mapStateToFilterProps, Filters_mapDispatchToProps)(FilterBox);
function Filters(props) {
    return (index_js_exposed["createElement"](components_Provider, { store: dataExplorerStore },
        index_js_exposed["createElement"](FilterBoxConnect, { prompt: props.prompt })));
}

// CONCATENATED MODULE: ./node_modules/d3/dist/package.js
var package_name = "d3";
var package_version = "5.9.2";
...
/* harmony default export */ var freedmanDiaconis = (function(values, min, max) {
  values = map.call(values, src_number).sort(ascending);
...
/* harmony default export */ var src_compose = (function(a, b) {
...
function rotateRadians(deltaLambda, deltaPhi, deltaGamma) {
  return (deltaLambda %= src_math_tau) ? (deltaPhi || deltaGamma ? src_compose(rotationLambda(deltaLambda), rotationPhiGamma(deltaPhi, deltaGamma))
...
function projectionMutator(projectAt) {
  ...
  function recenter() {
    ...
    projectTransform = src_compose(project, transform);
    projectRotateTransform = src_compose(rotate, projectTransform);
...
// CONCATENATED MODULE: ./Client/translator.ts

function textFormat(text, substitutions) {
    Object.keys(substitutions).forEach(function (subkey) {
        text = text.split("{" + subkey + "}").join(substitutions[subkey].toString());
    });
    return text.toString();
}
function numberFormat(number, units) {
    if (number == null)
        return "";
    var languageCode = dataExplorerStore.getState().languageCode;
    var formattedNumber = new Intl.NumberFormat(languageCode, { minimumFractionDigits: 1, maximumFractionDigits: 1 }).format(number);
    if (!units)
...
// CONCATENATED MODULE: ./Client/renderChart.ts
// @flow


var marginY = 10;
var marginX = 60;
var renderChart_width = 700;
var renderChart_height = 400;
...
var isBetween = function (val, up, low) { return val >= low && val <= up; };
...
function wrap(text, width) {
    text.each(function () {
        var text = src_select(this), words = text.text().split(/\s+/).reverse(), word, line = [], lineNumber = 0, lineHeight = 1.1, // ems
...
function renderChart(ref, dataset, animate, highlightIndex, highlightUpper, highlightLower, isTrend, updateHighlight) {
    var chart = src_select(ref);
    var select = chart.select(".main");
    var points = dataset.points.filter(function (point) { return point.type == 0 || isTrend; });
    var averages = dataset.points.filter(function (point) { return point.type != 0 && !isTrend; });
    var animationDuration = animate ? 600 : 0;
    if (points.length == 0) {
        points = averages;
        averages = [];
    }
    var x = band()
        .domain(points.map(function (point) { return point.label; }))
        .range([0, renderChart_width]);
    var y = src_linear_linear()
        .domain([0, src_max(dataset.points, function (point) { return (point.valueUpper || point.value || 0) * 1.1; })])
        .range([renderChart_height, 0]);
    ...
    chart.selectAll("g.x-axis")
        .attr("transform", "translate(" + marginX + "," + (renderChart_height + marginY) + ")")
        .style("font-size", 14)
    ...
    var enteredcvUpper = pointBinding.enter().append("g").attr("class", "cvUpper").append("rect");
    var enteredRect = pointBinding.enter().append("g").attr("class", "point").append("rect");
    enteredRect.attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - (isTrend ? 10 : 25) / 2; })
        .attr("width", isTrend ? 10 : 25)
        //.style("fill", "steelblue")
        .attr("ry", (isTrend ? 10 : 0))
        .attr("rx", (isTrend ? 10 : 0))
        .attr("y", renderChart_height)
        .transition()
        .duration(animationDuration)
        .attr("y", function (d) { return isTrend ? y(d.value || 0) - 5 : y(d.value || 0); })
        .attr("height", function (d) { return isTrend ? 10 : renderChart_height - y(d.value || 0); })
        .attr("fill", "steelblue")
        .attr("opacity", function (d, i) { return isPointInRange(highlightUpper, highlightLower, d) && i != highlightIndex ? 0.2 : 1; });
    enteredRect.append("title")
        .text(function (d) { return d.label + ": " + numberFormat(d.value || 0, dataset.unit); });
    pointBinding
        .select("rect")
        .transition()
        .duration(animationDuration)
        ...
        .attr("rx", (isTrend ? 10 : 0))
        .attr("width", isTrend ? 10 : 25)
        .attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - (isTrend ? 10 : 25) / 2; })
        .attr("height", function (d, i) { return isTrend ? 10 : renderChart_height - y(d.value || 0); })
        .attr("y", function (d) { return isTrend ? y(d.value || 0) - 5 : y(d.value || 0); })
        .attr("fill", "steelblue")
        .attr("opacity", function (d, i) { return isPointInRange(highlightUpper, highlightLower, d) && i != highlightIndex ? 1 : 1; }) //Point A to 0.2 to bring back functionality
        .select("title")
        .text(function (d) { return d.label + ": " + numberFormat(d.value || 0, dataset.unit); });
    pointBinding.on("mouseover", function (_, i) { return updateHighlight(i); });
    pointBinding.on("mouseout", function (_, i) { return updateHighlight(-1); });
    pointBinding.exit().remove();
    enteredcvUpper.attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - 25 / 2; })
        .attr("width", 25)
        .style("fill", "black")
        .attr("y", renderChart_height)
        .transition()
        .duration(function (_, i) { return 600; })
    ...
    cvUpperBinding
        ...
        .duration(animationDuration)
        .attr("width", 25)
        .attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - 25 / 2; })
        .attr("height", 2)
        .attr("y", function (d) { return y(d.valueUpper || 0); })
        .style("fill", "black");
    cvUpperBinding.exit().remove();
    var enteredcvConnect = cvConnectBinding.enter().append("g").attr("class", "cvConnect").append("rect");
    enteredcvConnect.attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - 2 / 2; })
        .attr("width", 2)
        .style("fill", "black")
        .attr("y", renderChart_height)
        .transition()
    ...
    cvConnectBinding
        ...
        .duration(animationDuration)
        .attr("width", 2)
        .attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - 2 / 2; })
        .attr("height", function (d) { return y(d.valueLower || 0) - y(d.valueUpper || 0); })
        .attr("y", function (d) { return y(d.valueUpper || 0); })
        .style("fill", "black");
    cvConnectBinding.exit().remove();
    var enteredcvLower = pointBinding.enter().append("g").attr("class", "cvLower").append("rect");
    enteredcvLower.attr("x", function (d, i) { return (i + 0.5) * (renderChart_width / points.length) - 25 / 2; })
        .attr("width", 25)
        .style("fill", "black")
        .attr("y", renderChart_height)
        .transition()
    ...
    var lowestValueIndex = (points.map(function (p) { return +p.value; }).indexOf(Math.min.apply(Math, points.map(function (p) { return +p.value; }))));
    if (points.length == 2)
        lowestValueIndex = 1.5;
    var leftLabel = lowestValueIndex < points.length / 2;
    enteredAverage
        .append("text")
        .attr("x", function () { return renderChart_width; })
        .attr("y", renderChart_height)
...
// CONCATENATED MODULE: ./Client/components/Chart.tsx
var Chart_extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Chart_Chart = /** @class */ (function (_super) {
    Chart_extends(Chart, _super);
    function Chart() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Chart.prototype.componentDidMount = function () {
        this.setState(Chart_assign({}, this.state, { isMounted: true, highlightIndex: -1 }));
    };
    Chart.prototype.componentDidUpdate = function () {
        var _this = this;
        var valueUpper = -1;
        var valueLower = -2;
        var isTrend = this.props.chartData.xAxis.includes("Trend") || this.props.chartData.xAxis.includes("Tendence");
        var highlighted = this.props.chartData.points.filter(function (p) { return p.type == 0 || isTrend; })[this.state.highlightIndex];
        if (highlighted) {
        ...
        if (this.state.isMounted && this.graph)
            renderChart(this.graph, this.props.chartData, this.props.animate, this.state.highlightIndex, valueUpper, valueLower, isTrend, function (index) { return _this.setState(Chart_assign({}, _this.state, { highlightIndex: index })); });
    };
    Chart.prototype.render = function () {
        var _this = this;
        // console.log(this.props.chartData);
        return (index_js_exposed["createElement"]("figure", null,
            index_js_exposed["createElement"]("figcaption", { className: "text-center", style: { margin: "0 10px" } },
                index_js_exposed["createElement"]("strong", null, this.props.chartData.title)),
            index_js_exposed["createElement"]("svg", { className: "chart", ref: function (self) { return _this.graph = self; }, id: "graph", zoomAndPan: "magnify", viewBox: "0 0 820 500", preserveAspectRatio: "xMidYMid meet", width: "820px", height: "500px" },
                index_js_exposed["createElement"]("defs", null,
                    index_js_exposed["createElement"]("filter", { x: "0", y: "0", width: "1", height: "1", id: "solid" },
                        index_js_exposed["createElement"]("feFlood", { floodColor: "#ffffff" }),
                        index_js_exposed["createElement"]("feComposite", { in: "SourceGraphic" }),
                        index_js_exposed["createElement"]("feComponentTransfer", null,
                            index_js_exposed["createElement"]("feFuncA", { type: "linear", slope: "0.7" }))),
                    index_js_exposed["createElement"]("pattern", { id: "linePattern", patternUnits: "userSpaceOnUse", width: "10", height: "10" },
                        index_js_exposed["createElement"]("path", { d: "M 0,11 l 5,-5 M -3,3 l 2.5,-10 M 3.75,1.25 5 2.5,-2.5, 0", strokeWidth: "4", shapeRendering: "auto", stroke: "red", strokeLinecap: "square" })),
                    index_js_exposed["createElement"]("linearGradient", { id: "gradient", x1: "0%", y1: "0%", x2: "100%", y2: "0", spreadMethod: "pad" },
                        index_js_exposed["createElement"]("stop", { offset: "0%", stopColor: "steelblue", stopOpacity: "1" }),
                        index_js_exposed["createElement"]("stop", { offset: "100%", stopColor: "#56a0dd", stopOpacity: "0" }))),
                index_js_exposed["createElement"]("g", { className: "y-axis" }),
                index_js_exposed["createElement"]("g", { className: "x-axis" }),
                index_js_exposed["createElement"]("text", { className: "yAxisLabel", y: "470", x: "380", dy: "1em", style: { textAnchor: "middle", fontWeight: "bold" } }),
                index_js_exposed["createElement"]("text", { className: "xAxisLabel", transform: "rotate(-90)", x: "-200", y: "20", style: { textAnchor: "middle", fontWeight: "bold" } }),
                index_js_exposed["createElement"]("g", { className: "main", transform: "translate(60,10)" }))));
    };
    return Chart;
}(index_js_exposed["Component"]));


// CONCATENATED MODULE: ./Client/containers/Charting.tsx
// @flow




var mapStateToChartProps = function (state, props) { return ({
    chartData: state.chartData,
    animate: props.animate
}); };
var ChartingConnect = connect_connect(mapStateToChartProps)(Chart_Chart);
function Charting(props) {
    return index_js_exposed["createElement"](components_Provider, { store: dataExplorerStore },
        index_js_exposed["createElement"](ChartingConnect, { animate: props.animate }));
}

// CONCATENATED MODULE: ./Client/components/SummaryTable.tsx
// @flow
...
function SummaryTable(props) {
    ...
    if (props.chartData.points.some(function (p) { return p.cvInterpretation == 2; }))
        if (knownBoundries) {
            cVWarningText = index_js_exposed["createElement"]("p", null,
                index_js_exposed["createElement"]("sup", null, "E"),
                textFormat(props.cvWarning, { warn: numberFormat(cvWarnAt || 0), suppress: numberFormat(cvSuppressAt || 0) }));
        }
        else {
            cVWarningText = index_js_exposed["createElement"]("p", null,
                index_js_exposed["createElement"]("sup", null, "E"),
    ...
    if (props.chartData.points.some(function (p) { return p.cvInterpretation == 1; }))
        if (knownBoundries) {
            cvSupressedText = index_js_exposed["createElement"]("p", null,
                index_js_exposed["createElement"]("sup", null, "F"),
                textFormat(props.cvSuppressed, { warn: numberFormat(cvWarnAt || 0), suppress: numberFormat(cvSuppressAt || 0) }));
        }
        else {
            cvSupressedText = index_js_exposed["createElement"]("p", null,
                index_js_exposed["createElement"]("sup", null, "F"),
    ...
    return (index_js_exposed["createElement"]("div", { className: "container-fluid" },
        index_js_exposed["createElement"]("div", { className: "row brdr-bttm mrgn-bttm-0" },
            index_js_exposed["createElement"]("div", { className: "col-md-12 table-data" },
                index_js_exposed["createElement"]("table", { className: "table table-striped table-condensed table-xCondensed text-center mrgn-bttm-sm", id: "chartgridview" },
                    index_js_exposed["createElement"]("caption", null, props.chartData.title),
                    index_js_exposed["createElement"]("thead", null,
                        index_js_exposed["createElement"]("tr", null,
                            index_js_exposed["createElement"]("th", { className: "text-left", scope: "col" }, props.chartData.xAxis),
                            index_js_exposed["createElement"]("th", { className: "text-center", scope: "col" }, props.chartData.yAxis),
                            index_js_exposed["createElement"]("th", { className: "text-center", scope: "col" },
                                "95% ",
                                index_js_exposed["createElement"]("abbr", { title: "Confidence Interval" }, "CI")))),
                    index_js_exposed["createElement"]("tbody", null, props.chartData.points.map(function (point, index) {
                        switch (point.cvInterpretation) {
                            // Data is in the red (66%+)
                            case 1:
                                return (index_js_exposed["createElement"]("tr", { key: index, style: ({ backgroundColor: "red" }) },
                                    index_js_exposed["createElement"]("td", { className: "text-left" }, point.text),
                                    index_js_exposed["createElement"]("td", null,
                                        index_js_exposed["createElement"]("sup", null, "F")),
                                    index_js_exposed["createElement"]("td", null,
                                        typeof point.valueLower != "number" ? "-" : numberFormat(point.valueLower),
                                        " - ",
                                        typeof point.valueUpper != "number" ? "-" : numberFormat(point.valueUpper),
                                        " ")));
                            // Data is in the red (33%+)
                            case 2:
                                return (index_js_exposed["createElement"]("tr", { key: index, style: ({ backgroundColor: "yellow" }) },
                                    index_js_exposed["createElement"]("td", { className: "text-left" }, point.text),
                                    index_js_exposed["createElement"]("td", null,
                                        typeof point.value != "number" ? "-" : numberFormat(point.value),
                                        index_js_exposed["createElement"]("sup", null, "E")),
                                    index_js_exposed["createElement"]("td", null,
                                        typeof point.valueLower != "number" ? "-" : numberFormat(point.valueLower),
                                        " - ",
                            ...
                            // Data is a Okay!
                            default:
                                return (index_js_exposed["createElement"]("tr", { key: index },
                                    index_js_exposed["createElement"]("td", { className: "text-left" }, point.text),
                                    index_js_exposed["createElement"]("td", null, typeof point.value != "number" ? "-" : numberFormat(point.value)),
                                    index_js_exposed["createElement"]("td", null,
                                        typeof point.valueLower != "number" ? "-" : numberFormat(point.valueLower),
                                        " - ",
                                        typeof point.valueUpper != "number" ? "-" : numberFormat(point.valueUpper),
            ...
            index_js_exposed["createElement"]("div", { className: "col-md-12 mrgn-tp-0 small notes bg-warning" },
                index_js_exposed["createElement"]("p", null,
                    index_js_exposed["createElement"]("strong", null, "Notes:"),
                    " ",
                    props.chartData.notes),
                index_js_exposed["createElement"]("p", null,
                    index_js_exposed["createElement"]("strong", null, "Source:"),
                    " ",
...
// CONCATENATED MODULE: ./Client/containers/SummaryTable.tsx
// @flow




var mapStateToSummaryTableProps = function (state, props) { return ({
    chartData: state.chartData,
...
// TODO: Fix typing issue
var SummaryTableConnect = connect_connect(mapStateToSummaryTableProps)(SummaryTable);
function SummaryTable_SummaryTable(props) {
    return (index_js_exposed["createElement"](components_Provider, { store: dataExplorerStore },
        index_js_exposed["createElement"](SummaryTableConnect, { cvWarning: props.cvWarning, cvSuppressed: props.cvSuppressed, cvWarningAlt: props.cvWarningAlt, cvSuppressedAlt: props.cvSuppressedAlt })));
}

// CONCATENATED MODULE: ./Client/components/DescriptionTable.tsx
// @flow

var DescriptionTable = function (props) {
    var notApplicable = (index_js_exposed["createElement"]("div", null,
        index_js_exposed["createElement"]("span", { "aria-hidden": true }, "N/A"),
        index_js_exposed["createElement"]("span", { className: "wb-inv" }, "&emdash;")));
    return (index_js_exposed["createElement"]("table", { className: "table table-striped table-hover table-condensed table-bordered" },
        index_js_exposed["createElement"]("tbody", null,
            index_js_exposed["createElement"]("tr", null,
                index_js_exposed["createElement"]("th", null, props.definitionText),
                index_js_exposed["createElement"]("td", null, props.definition || notApplicable)),
            index_js_exposed["createElement"]("tr", null,
                index_js_exposed["createElement"]("th", null, props.dataAvailableText),
                index_js_exposed["createElement"]("td", null, props.dataAvailable || notApplicable)),
            index_js_exposed["createElement"]("tr", null,
                index_js_exposed["createElement"]("th", null, props.methodsText),
                index_js_exposed["createElement"]("td", null, props.methods || notApplicable)),
            index_js_exposed["createElement"]("tr", null,
                index_js_exposed["createElement"]("th", null, props.remarksText),
                index_js_exposed["createElement"]("td", null, props.remarks || notApplicable)))));
};

// CONCATENATED MODULE: ./Client/containers/DescriptionTable.tsx
var DescriptionTable_assign = (undefined && undefined.__assign) || function () {
    DescriptionTable_assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
                t[p] = s[p];
    ...
    return DescriptionTable_assign.apply(this, arguments);
};




var mapStateToDescriptionTableProps = function (state, props) { return ({
...
var DescriptionTableConnect = connect_connect(mapStateToDescriptionTableProps)(DescriptionTable);
function DescriptionTable_DescriptionTable(props) {
    return (index_js_exposed["createElement"](components_Provider, { store: dataExplorerStore },
        index_js_exposed["createElement"](DescriptionTableConnect, DescriptionTable_assign({}, props))));
}

// CONCATENATED MODULE: ./Client/containers/InitializeChartDataStore.tsx
// @flow


var InitializeChartDataStore = function (props) {
    dataExplorerStore.dispatch(initState(props.state));
    return null;
};

// CONCATENATED MODULE: ./Client/app.ts
/* concated harmony reexport FilterBoxConnect */__webpack_require__.d(__webpack_exports__, "FilterBoxConnect", function() { return FilterBoxConnect; });
/* concated harmony reexport Filters */__webpack_require__.d(__webpack_exports__, "Filters", function() { return Filters; });
/* concated harmony reexport ChartingConnect */__webpack_require__.d(__webpack_exports__, "ChartingConnect", function() { return ChartingConnect; });
/* concated harmony reexport Charting */__webpack_require__.d(__webpack_exports__, "Charting", function() { return Charting; });
/* concated harmony reexport SummaryTableConnect */__webpack_require__.d(__webpack_exports__, "SummaryTableConnect", function() { return SummaryTableConnect; });
/* concated harmony reexport SummaryTable */__webpack_require__.d(__webpack_exports__, "SummaryTable", function() { return SummaryTable_SummaryTable; });
/* concated harmony reexport DescriptionTableConnect */__webpack_require__.d(__webpack_exports__, "DescriptionTableConnect", function() { return DescriptionTableConnect; });
/* concated harmony reexport DescriptionTable */__webpack_require__.d(__webpack_exports__, "DescriptionTable", function() { return DescriptionTable_DescriptionTable; });
/* concated harmony reexport InitializeChartDataStore */__webpack_require__.d(__webpack_exports__, "InitializeChartDataStore", function() { return InitializeChartDataStore; });
